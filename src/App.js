                  ...
                  datasets: [
                    {
                      ...
                      data: [
                        filteredFiles.filter(file => file.type === 'video').length,
                        filteredFiles.filter(file => file.type === 'audio').length,
                        filteredFiles.filter(file => file.type === 'document').length,
                        filteredFiles.filter(file => file.type === 'image').length
                      ],
                      backgroundColor: [
                        'rgba(255, 99, 132, 0.2)',
                        'rgba(54, 162, 235, 0.2)',
